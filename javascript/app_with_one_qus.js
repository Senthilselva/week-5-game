...
function showAnsPic(feedback){
    ...
    var picWindowTimeOut = setTimeout(selectAQuestion, 5000);
...
$('input').on('click',function(){
    ...
    if(check == true) {
       ...
       showAnsPic("Awesome! You are right!");

    } else {
        showAnsPic("Nope! You are wrong");
        //alert("wrong answer");
